...
export const metadata: Metadata = {
    title: 'Terms of Use | RG Associates',
    description: 'Terms of Use for RG Associates website. Please read these terms carefully before using our website.',
};
        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-3xl px-6 lg:px-8">
                ...
                <div className="text-base leading-7 text-gray-700 space-y-6">
                    ...
                    <p>
                        Welcome to the website of RG Associates. By accessing or using this website, you agree to comply with and be bound by the following Terms of Use. If you do not agree with these terms, please do not use our website.
                    </p>
                    ...
                    <p>
                        The content provided on this website is for general informational purposes only and does not constitute legal advice. Accessing this website or communicating with RG Associates via email or through the website does not create an attorney-client relationship. You should not act or refrain from acting on the basis of any information included on this site without seeking appropriate legal advice from a qualified attorney.
                    </p>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        <li>You are seeking information about RG Associates of your own accord.</li>
                    ...
                    <p>
                        All content, including text, graphics, logos, and images, on this website is the property of RG Associates and is protected by applicable intellectual property laws. You may not reproduce, distribute, or use any content from this website without our prior written permission.
                    </p>

                    <h2 className="text-2xl font-bold tracking-tight text-[#051427] mt-8 mb-4">4. Limitation of Liability</h2>
                    <p>
                        RG Associates assumes no liability for any interpretation and/or use of the information contained on this website, nor does it offer a warranty of any kind, either expressed or implied. We are not responsible for any loss or damage resulting from your reliance on the information provided herein.
                    </p>

                    <h2 className="text-2xl font-bold tracking-tight text-[#051427] mt-8 mb-4">5. Third-Party Links</h2>
                    <p>
                        This website may contain links to third-party websites for your convenience. RG Associates does not endorse or control the content of these external sites and is not responsible for their privacy practices or accuracy.
                    </p>

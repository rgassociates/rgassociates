                            ...
                            <form action={async (formData) => {
                                ...
                                <div className="mt-8">
                                    <button
                                        ...
                                        className={`group w-full inline-flex items-center justify-center gap-2 rounded-lg px-8 py-4 text-base font-semibold shadow-xl transition-all duration-300 ${agreed && !isSubmitting
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        title: 'Email',
                                        content: 'info@rglegalsolutions.in',
                                        link: 'mailto:info@rglegalsolutions.in'
                                    },
                                ].map((item, index) => (
                                    <motion.div
                                        key={item.title}

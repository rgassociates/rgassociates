...
export default function HeroSection() {
    ...
    return (
        <section className="relative isolate overflow-hidden bg-gradient-to-br from-[#051427] via-[#0A1A2F] to-[#051427] pt-24 pb-16 sm:pt-28 sm:pb-20">
            ...
            {/* Decorative Gradient Blobs with VISIBLE Floating Animation */}
            <motion.div
                className="absolute top-0 right-0 -translate-y-12 translate-x-12 w-96 h-96 bg-[#D4A646]/20 rounded-full blur-3xl"
                animate={{
                    y: [0, -60, 0],
                    x: [0, 40, 0],
                    scale: [1, 1.3, 1],
            ...
            />
            <motion.div
                className="absolute bottom-0 left-0 translate-y-12 -translate-x-12 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl"
                animate={{
                    y: [0, 60, 0],
                    x: [0, -40, 0],
                    scale: [1, 1.4, 1],
            ...
            <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        ...
                        >
                            {/* Free Consultation Button - Simple with Zoom */}
                            <button
                                className="inline-flex items-center justify-center gap-2 px-8 py-4 text-lg font-semibold bg-[#D4A646] text-[#051427] rounded-lg shadow-md hover:bg-[#E5B657] hover:scale-105 transition-all duration-200"
                            >
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={isSubmitting}
                                    className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 text-lg font-semibold bg-[#D4A646] text-[#051427] rounded-lg shadow-md hover:bg-[#E5B657] hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isSubmitting ? (
                                        <>
                                            <svg className="animate-spin -ml-1 mr-2 h-5 w-5 text-[#051427]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
